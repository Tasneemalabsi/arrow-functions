...
// the constructor function Student with the object elements {name: "Joe", age: "Schmoe", hometown: 100}
// 2. What is "this" when joe.scopeArrow() is invoked?
// Window {window: Window, self: Window, document: document, name: "", location: Location, …}
// 3. Explain why "this" is different when an arrow function is used.
// because the arrow function does not have its own bindings to this or super, and should not be used as methods and can not be used and invoked as constructors.